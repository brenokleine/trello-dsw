    ...
    <div class="w-64 h-48 m-3 rounded-lg shadow-md hover:scale-105 duration-75 "
        ...
        <router-link :to="{ name: 'quadroDetail', params: { id: props.id } }"
            ...
            <div class="flex flex-row w-full justify-between">
                <div class="p-1">
                    <svg @click.prevent="favouriteBoard" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                        :style="{ fill: isFavourite ? 'yellow' : 'gray' }" class="size-6 hover:bg-gray-700">
                ...
                <div class="p-1">
                    <svg @click.prevent="openPdfModal" xmlns="http://www.w3.org/2000/svg" fill="none"
                        viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6 hover:bg-gray-700">
